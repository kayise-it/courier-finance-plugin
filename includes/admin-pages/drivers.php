            ...
            <div class="mt-5 pt-4 border-t border-gray-200">
                ...
                <label for="is_active" class="inline-flex items-center cursor-pointer select-none">
                    <input type="checkbox" id="is_active" name="is_active" value="1" class="sr-only peer"
                           ...
                           ?>>
                    <span class="w-11 h-6 bg-gray-300 rounded-full relative transition peer-checked:bg-blue-600"></span>
                    <span class="w-5 h-5 bg-white rounded-full -ml-10 mr-3 transition shadow-sm peer-checked:translate-x-5"></span>
