<div>
    <tr>
        <th><label for="origin_country_select">Origin Country</label></th>
        <td>
    ...
    <tr>
        ...
        <td>
            ...
            <?php else: ?>
                <?php echo KIT_Deliveries::selectAllCitiesByCountry('origin_city', 'origin_city_select', 3, $required = 'required', ''); ?>
            <?php endif; ?>
        </td>
    </tr>
</div>