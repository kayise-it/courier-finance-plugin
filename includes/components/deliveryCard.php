...
<<<<<<< HEAD
    ...
    <div class="flex items-center justify-center gap-1 mb-1 text-[11px] text-blue-700">
        ...
        <span class="font-semibold">Truck Assignment</span>
    </div>
...
<<<<<<< HEAD
    ...
    <div class="mt-2 text-[11px] text-gray-700 leading-tight border-t border-gray-100 pt-2 space-y-1">
        <div class="flex items-center gap-1.5">
            ...
            <span class="font-semibold text-gray-800"><?php echo !empty($delivery->truck_number) ? htmlspecialchars($delivery->truck_number) : 'Unassigned'; ?></span>
        </div>
        <div class="flex items-center gap-1.5">
            <span class="text-gray-500">Driver:</span>
            <span><?php echo !empty($delivery->driver_name) ? htmlspecialchars($delivery->driver_name) : 'Not set'; ?></span>
        </div>
        <?php if (!empty($delivery->driver_phone)) : ?>
            <div class="text-gray-500"><?php echo htmlspecialchars($delivery->driver_phone); ?></div>
        <?php endif; ?>
    </div>
