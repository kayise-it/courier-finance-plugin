...
class Database
{
    ...
    /**
     * Insert example/default services if the table is empty.
    ...
    public static function seed_services()
    {
        ...
        // bail if we already have at least one row
        ...
        $defaults = [
            ...
            [
                ...
                'description' => 'Cross-border shipping with customs assistance.',
                'image' => 'fas fa-globe',
            ],
        ];
    ...
    public static function activate()
    {
        ...
        // populate a few sample services so the homepage shortcode has something
        // to render right away (this is safe if table already contains rows)
        self::seed_services();
